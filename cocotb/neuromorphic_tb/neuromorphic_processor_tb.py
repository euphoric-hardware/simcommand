...
async def neuromorphic_processor_tb(dut):
    ...
    image = fetch("../../test/resources/NeuromorphicProcessor/image.txt")
    results = fetch("../../test/resources/NeuromorphicProcessor/results_round.txt") if (USEROUNDEDWGHTS) else fetch("../../test/resources/NeuromorphicProcessor/results_toInt.txt")
